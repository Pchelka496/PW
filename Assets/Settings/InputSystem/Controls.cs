...
public partial class @Controls: IInputActionCollection2, IDisposable
{
    ...
    ~@Controls()
    {
        Debug.Assert(!m_Construct.enabled, "This will cause a leak and performance issues, Controls.Construct.Disable() has not been called.");
        Debug.Assert(!m_Workshop.enabled, "This will cause a leak and performance issues, Controls.Workshop.Disable() has not been called.");
